...
# o Erro padrão, se, é o desvio padrão da amostra dividido raiz da amostra
se <- sd(samp)/sqrt(60)
...
#Exercício 3 
# Para o intervalos de confiança ser válido, a média amostral precisa ter distribuição normal e 
# ter um erro padrão igual a s/raiz(n). 
